 ...
 * @param {object} [opts]
 * @param {string} [opts.brandDomain] - Domain for footer branding (default: 'festie.us')
 * @returns {string} SVG markup
 */
function buildPicksCardSvg(festival, profile, opts = {}) {
...
module.exports = { buildPicksCardSvg };
