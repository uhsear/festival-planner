 ...
 *
 * @param {object} config - loaded config with PUBLIC_DIR
 * @returns {{ inlineHashes: any, contentSecurityPolicy: string, exportContentSecurityPolicy: string }}
 */
function buildCspPolicies(config) {
