...
const { escapeHtml } = require('./helpers/sanitize');

function renderResetFormPage(token, origin, nonce) {
  ...
  <div class="reset-container">
    <div class="reset-card">
      ...
      <div class="reset-footer">
        <p><a href="${escapeHtml(origin)}" style="color: #aaa; text-decoration: none;">Back to Festie</a></p>
      </div>
    </div>
  </div>
...
function renderResetErrorPage(message, nonce) {
  const nonceAttr = nonce ? ` nonce="${escapeHtml(nonce)}"` : '';
  return `<!DOCTYPE html>
<html lang="en">
<head>
...
module.exports = { renderResetFormPage, renderResetErrorPage, escapeHtml };
