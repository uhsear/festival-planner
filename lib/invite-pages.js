...
function renderInviteJoinPage({ crewName, festivalName, inviteCode, origin }) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
function renderInviteErrorPage(origin, message) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
module.exports = { escapeHtml, renderInviteJoinPage, renderInviteErrorPage };
