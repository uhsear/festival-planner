...
function buildContentSecurityPolicy(config, inlineHashes, options = {}) {
  ...
  // CSP Level 2: hashes cause 'unsafe-inline' to be silently ignored.
  // We need 'unsafe-inline' for motion/react dynamic styles, so omit hashes.
  ...
  connectParts.push('https://fonts.googleapis.com');
