 ...
 */
function createCloseHandler({ server, io, config, state, log, pool, redis, cacheBus, emitter, clearPresenceTimers, avatarPool, inFlightRequests }) {
