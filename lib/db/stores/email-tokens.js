...
function createEmailTokensStore(pool) {
  return {
    ...
    async createResetToken(userId, tokenHash) {
      await pool.query(
    ...
    async setEmailUnverified(userId, email) {
      await pool.query(
    ...
    async createVerificationToken(userId, tokenHash, email, ttlHours) {
      await pool.query(
    ...
    async invalidateVerificationTokens(userId) {
      await pool.query(
...
module.exports = { createEmailTokensStore };
