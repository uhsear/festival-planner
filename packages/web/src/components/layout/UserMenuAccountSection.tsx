    ...
    >
      ...
      <div className="flex items-center justify-between gap-[var(--space-5)] py-2.5 border-b border-[var(--color-overlay-3)]">
        <div className="flex flex-col gap-[var(--space-1)] min-w-0 flex-1">
          ...
          <span className="text-[length:var(--font-size-13)] text-text-primary overflow-hidden text-ellipsis whitespace-nowrap flex items-center gap-[var(--space-3)]">
      ...
      <div className="flex items-center justify-between gap-[var(--space-5)] py-2.5 border-b border-[var(--color-overlay-3)]">
        <div className="flex flex-col gap-[var(--space-1)] min-w-0 flex-1">
          ...
          {user.email ? (
            ...
            <span className="text-[length:var(--font-size-13)] text-text-muted italic overflow-hidden text-ellipsis whitespace-nowrap flex items-center gap-[var(--space-3)]">
              Not set
            </span>
          )}
        </div>
