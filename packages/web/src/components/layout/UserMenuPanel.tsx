  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="user-menu-panel fixed top-[68px] right-6 z-[var(--z-modal)] w-[min(360px,calc(100vw-20px))] max-h-[min(calc(100vh-92px),760px)] overflow-y-auto rounded-DEFAULT border border-border-light bg-[rgba(18,18,18,.96)] p-6 shadow-[0_18px_48px_rgba(0,0,0,.55),inset_0_1px_0_var(--color-overlay-2)] backdrop-saturate-[180%] backdrop-blur-[24px] pb-6 overscroll-contain"
        ref={panelRef}
        role="dialog"
        aria-modal="true"
