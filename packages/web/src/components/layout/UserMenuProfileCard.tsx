    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-[5px] min-w-0">
          ...
          <div className="text-xs text-text-secondary max-w-full overflow-hidden text-ellipsis whitespace-nowrap">
            Account identity across every festival
          </div>
          <div className="flex flex-wrap gap-[var(--space-3)]">
            <span className="inline-flex items-center gap-[var(--space-2)] px-2 py-[3px] rounded-full bg-white/5 border border-border-light text-[length:var(--font-size-11)] font-bold tracking-[.4px] uppercase text-text-secondary">
              Account
            </span>
            {user.isAdmin && (
              <span className="inline-flex items-center gap-[var(--space-2)] px-2 py-[3px] rounded-full bg-[rgba(var(--accent-coral-rgb),.12)] border border-[rgba(var(--accent-coral-rgb),.25)] text-[length:var(--font-size-11)] font-bold tracking-[.4px] uppercase text-accent-coral">
                Admin
              </span>
            )}
          </div>
      ...
      {currentFestival && (
        <section
          ...
          data-testid="festival-profile-section"
        >
          <div className="text-[length:var(--font-size-11)] font-bold tracking-[1.2px] uppercase text-text-secondary mb-1.5">
            Festival Profile
          </div>
          ...
          <div className="flex flex-wrap gap-[var(--space-3)] mb-2.5">
            {currentProfile ? (
              <>
                <span className="inline-flex items-center gap-[var(--space-2)] px-2 py-[3px] rounded-full bg-[var(--color-aqua-a1)] border border-[rgba(0,232,208,.28)] text-[length:var(--font-size-11)] font-bold tracking-[.4px] uppercase text-accent-aqua">
                  Joined
                </span>
                <span className="inline-flex items-center gap-[var(--space-2)] px-2 py-[3px] rounded-full bg-white/5 border border-border-light text-[length:var(--font-size-11)] font-bold tracking-[.4px] uppercase text-text-secondary">
                  Notes stay private
            ...
            <div className="grid grid-cols-2 gap-[var(--space-4)] mb-3 max-[380px]:grid-cols-1">
              {(
                ...
                >
                  ...
                  <span className="text-[length:var(--font-size-11)] text-text-secondary">{label}</span>
                </div>
              ))}
            </div>
          )}
