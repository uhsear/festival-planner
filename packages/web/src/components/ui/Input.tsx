      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-1 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-secondary transition-colors inline-flex items-center justify-center min-h-11 min-w-11"
