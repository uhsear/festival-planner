  ...
  return (
    <div className="space-y-4 px-4 pb-24" aria-busy="true" aria-label="Loading wrap">
      ...
      <div className="flex flex-col items-center gap-2.5 py-6">
        <div className="skeleton-shimmer h-7 w-[200px]" />
        <div className="skeleton-shimmer h-3.5 w-[140px]" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="skeleton-shimmer h-[88px] rounded-xl opacity-75"
          />
        ))}
      </div>
      ...
      <div className="flex flex-col gap-2.5">
        <div className="skeleton-shimmer h-4 w-[120px]" />
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-1.5">
              ...
              <div className="skeleton-shimmer h-2.5 w-[35%]" />
            </div>
            <div className="skeleton-shimmer h-3.5 w-9" />
          </div>
        ))}
      </div>
    </div>
