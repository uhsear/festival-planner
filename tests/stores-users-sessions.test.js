...
const createUsersStore = require('../lib/db/stores/users');
const createSessionsStore = require('../lib/db/stores/sessions');
...
const mockUtils = {
  toISOString: (val) => (val ? new Date(val).toISOString() : null),
};
