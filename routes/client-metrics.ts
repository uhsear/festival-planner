...
const VALID_METRICS: Record<string, { min: number; max: number; unitDivisor: number }> = Object.freeze({
...
export default function createClientMetricsRoutes(deps: any) {
  ...
  let webVitalsHistogram: any = null;
  ...
  router.post('/web-vitals', limiter, (req: any, res: any) => {
